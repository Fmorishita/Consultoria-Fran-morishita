...
export function CrossIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" className={className}>
      <path d="m5 5 10 10M15 5 5 15" strokeLinecap="square" />
    </svg>
  )
}
...
export function ArrowIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true" className={className}>
      <path d="M3 10h13m-5-5 5 5-5 5" strokeLinecap="square" />
    </svg>
  )
}
...
/** Rayos del emblema, usados como remate gráfico de sección. */
export function SunburstRule({ className = '' }: IconProps) {
  return (
    <svg viewBox="0 0 240 24" className={className} aria-hidden="true" fill="none">
      <g stroke="currentColor" strokeWidth="1">
        <path d="M0 20h84M156 20h84" />
        <path d="M120 22 108 6M120 22 120 2M120 22 132 6M120 22 96 12M120 22 144 12" opacity="0.85" />
      </g>
      <circle cx="120" cy="22" r="1.75" fill="currentColor" />
    </svg>
  )
}
